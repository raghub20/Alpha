...
export class AddCostModelComponent {
  ...
  saveCostModel() {
    ...
    if (this.data){
      this.costModelsService.addCostModel(this.addCostModelForm.value, levelDetails,this.data.costModelId);
      }else{
      this.costModelsService.addCostModel(this.addCostModelForm.value, levelDetails,undefined);
    }
  ...
  deleteCostModel(){
    this.costModelsService.deleteCostModel(this.data.costModelId);
    this.dialogRef.close();
    }
