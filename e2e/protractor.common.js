...
const config = {
  ...
  specs: [
    '../e2e/src/features/**/choose-column-data.feature'     // Specs here are the cucumber feature files
  ],
  ...
  cucumberOpts: {
    ...
    tags: ['@197'],                           // <string[]> (expression) only execute the features or scenarios with tags matching the expression
