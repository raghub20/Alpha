...
When('The client contact clicks the column filter icon in mobile view', async function () {
...
Then('The client contact is able to see column filter pop up in mobile view', async function () {
  return await choosecolumn.getcolumnfilterpopup().isDisplayed();
});



Then('The client contact checks level column as true in mobile view', async function () {
   await choosecolumn.getlevelstatus().getAttribute('aria-checked').then(async(text)=> {
    if (text == 'true') {
      return;
    }
...
Then('The client contact checks departure as true in mobile view', async function () {
  await choosecolumn.getdeparturestatus().getAttribute('aria-checked').then(async(text)=> {
    if (text == 'true') {
      return;
    }
...
Then('The client contact checks destination as true in mobile view', async function () {
  await choosecolumn.getdestinationstatus().getAttribute('aria-checked').then(async(text)=> {
    if (text == 'true') {
      return;
    }
...
Then('The client contact checks status date as true in mobile view', async function () {
  await choosecolumn.getstatusdatestatus().getAttribute('aria-checked').then(async(text)=> {
    if (text == 'true') {
      return;
    }
...
Then('The client contact checks business unit as true in mobile view', async function () {
  await choosecolumn.getbusinessstatus().getAttribute('aria-checked').then(async(text)=> {
    if (text == 'true') {
      return;
    }
...
Then('The client contact checks invitation sent date as true in mobile view', async function () {
  await choosecolumn.getinvitationstatus().getAttribute('aria-checked').then(async(text)=> {
    if (text == 'true') {
      return;
    }
...
Then('The client contact checks created by as true in mobile view', async function () {
  await choosecolumn.getcreatedbystatus().getAttribute('aria-checked').then(async(text)=> {
    if (text == 'true') {
      return;
    }
...
Then('The client contact checks Email as true in mobile view', async function () {
  await choosecolumn.getemailstatus().getAttribute('aria-checked').then(async(text)=> {
    if (text == 'true') {
      return;
    }
...
Then('The client contact clicks apply filter in mobile view', async function () {
  await choosecolumn.getApplyfilter().isDisplayed().then(async()=>{
    return await choosecolumn.getApplyfilter().click();
  });
});
...
Then('The client contact is able to see level column in mobile view', async function () {
  return await choosecolumn.getverifylevel().isDisplayed();
});



Then('The client contact is able to see departure column in mobile view', async function () {
  return await choosecolumn.getverifydeparture().isDisplayed();
});



Then('The client contact is able to see destination column in mobile view', async function () {
  return await choosecolumn.getverifydestination().isDisplayed();
});



Then('The client contact is able to see status date column in mobile view', async function () {
  return await choosecolumn.getverifystatusdate().isDisplayed();
});



Then('The client contact is able to see business unit column in mobile view', async function () {
  return await choosecolumn.getverifybusinessunit().isDisplayed();
});



Then('The client contact is able to see invitation sent date column in mobile view', async function () {
  return await choosecolumn.getverifyinvitation().isDisplayed();
});



Then('The client contact is able to see created by column in mobile view', async function () {
  return await choosecolumn.getverifycreatedby().isDisplayed();
});



Then('The client contact is able to see Email column in mobile view', async function () {
  return await choosecolumn.getverifyemail().isDisplayed();
});
...
Then('The client contact checks all the columns true in mobile view', async function () {
  await browser.driver.manage().window().setSize(500,900);
  await choosecolumn.getlevelstatus().getAttribute('aria-checked').then(async(text)=> {
    if (text == 'true') {
      return;
...
Then('The client contact checks level column as false in mobile view', async function () {
  return await choosecolumn.getLevel().click();
});



Then('The client contact checks departure as false in mobile view', async function () {
  return await choosecolumn.getDeparture().click();;
});



Then('The client contact checks destination as false in mobile view', async function () {
  return await choosecolumn.getDestination().click();
});



Then('The client contact checks status date as false in mobile view', async function () {
  return await choosecolumn.getstatusdate().click();
});



Then('The client contact checks business unit as false in mobile view', async function () {
  return await choosecolumn.getbusinessunit().click();
});



Then('The client contact checks invitation sent date as false in mobile view', async function () {
  return await choosecolumn.getinvitationsent().click();
});


Then('The client contact checks created by as false in mobile view', async function () {
  return await choosecolumn.getcreatedby().click();
});


Then('The client contact checks Email as false in mobile view', async function () {
  return await choosecolumn.getemail().click();
});



Then('The client contact does not see level column in mobile view', async function () {
  return await expect(choosecolumn.getverifylevel().isPresent()).to.become(false);
});



Then('The client contact does not see departure column in mobile view', async function () {
  return await expect(choosecolumn.getverifydeparture().isPresent()).to.become(false);
});



Then('The client contact does not see destination column in mobile view', async function () {
  return await expect(choosecolumn.getverifydestination().isPresent()).to.become(false);
});



Then('The client contact does not see status date column in mobile view', async function () {
  return await expect(choosecolumn.getverifystatusdate().isPresent()).to.become(false);
});



Then('The client contact does not see business unit column in mobile view', async function () {
  return await expect(choosecolumn.getverifybusinessunit().isPresent()).to.become(false);
});



Then('The client contact does not see invitation sent date column in mobile view', async function () {
  return await expect(choosecolumn.getverifyinvitation().isPresent()).to.become(false);
});



Then('The client contact does not see created by column in mobile view', async function () {
  return await expect(choosecolumn.getverifycreatedby().isPresent()).to.become(false);
});



Then('The client contact does not see Email column in mobile view', async function () {
  return await expect(choosecolumn.getverifyemail().isPresent()).to.become(false);
});
...
Then('The client contact is unable to uncheck fullname in mobile view', async function () {
  await browser.driver.manage().window().setSize(500,900);
  await expect(choosecolumn.getfullnamedisabled().isEnabled()).to.become(true);
  await choosecolumn.getfullname().click();
  return await expect(choosecolumn.getfullnamedisabled().isEnabled()).to.become(true);
...
Then('The client contact is unable to uncheck status in mobile view', async function () {
  await browser.driver.manage().window().setSize(500,900);
  await expect(choosecolumn.getfullnamedisabled().isEnabled()).to.become(true);
  await choosecolumn.getstatus().click();
  return await expect(choosecolumn.getfullnamedisabled().isEnabled()).to.become(true);
...
Then('All the check box are unchecked in mobile view',async()=>{
  await browser.driver.manage().window().setSize(500,900);
...
Then('The client contact verifies selected columns in mobile view', async function () {
   await choosecolumn.getSelectedcount().getText().then(async (count)=>{
    var cnt: number = parseInt(count);
    return await expect(choosecolumn.getcalculatedcount()).equals(cnt);
  });
...
Then('The client contact verifies unselected columns in mobile view', async function () {
  await browser.driver.manage().window().setSize(500,900);
  await choosecolumn.getSelectedcount().getText().then(async (count)=>{
   var cnt: number = parseInt(count);
   return await expect(choosecolumn.getunselectedcount()).equals(cnt);
...
Then('The client contact clicks reset button in mobile view', async function(){
  await browser.driver.manage().window().setSize(500,900);
  return await choosecolumn.getReset().click();
});

Then('The client contact is able to see firstname column in mobile view', async function(){
  return await choosecolumn.getverifyfullname().isDisplayed();
});

Then('The client contact is able to see status column in mobile view', async function(){
  return await choosecolumn.getverifystatus().isDisplayed();
});

//7) Scenario: To verify the first and last columns in mobile view

Then('The first column is full name in mobile view',async function(){
  await browser.driver.manage().window().setSize(500,900);
  await choosecolumn.getfirstcolumn().getText().then(async(text)=>{
    return await expect(text).equals("Full Name");
  })
});
Then('The last column is status in mobile view',async function(){
  await choosecolumn.getlastcolumn().getText().then(async(text)=>{
    return await expect(text).equals("Status");
  })
});