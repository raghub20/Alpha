...
export class Needsassessment {
    ...
    get(): promise.Promise<any> {
         ...
         return element(by.css(".candidate-btn.mat-button")).click();
    }

    relocatingYesOrNoField():ElementFinder{
        return element(by.cssContainingText(".candidate-headertxt","Is anyone else relocating with you ?"));
    }
    numberOfRelocatingMembers():ElementFinder{
        return element(by.cssContainingText(".candidate-headertxt","How many people, including yourself, are relocating ?"));
    }
    departureAddressField():ElementFinder{
        return element(by.cssContainingText(".candidate-headertxt","Please enter your current address"));
    }
    ...
    destinationAddressPrepopulate():ElementFinder{
        return element(by.cssContainingText(".ng-tns-c22-8","Danbury"));
    }
