...
export class UpdateCandidate {
   ...
   // browser.get('/#/project-alpha/candidate-profiles');
    element(by.xpath('//*[@class="mat-cell cdk-column-level-levelName mat-column-level-levelName ng-star-inserted"]')).click();
    }
