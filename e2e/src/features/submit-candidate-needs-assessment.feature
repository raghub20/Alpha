...
To validate the candidate needs assessment data is submitted
  ...
  Scenario: To validate all input fields for candidate needs assessment
    Then The candidate updates if anyone else is relocating
     ...
     And The candidate updates TypeOfhome information
  ...
  Scenario: To verify calendar control for estimated move date
    ...
    # Scenario: To verify preferred contact number is mandatory
    # When The candidate clicks on preferred contact field and clicks outside
    # Then The candidate seees mandatory validation message
...
@Mobile
  ...
  Scenario: To verify calendar control for estimated move date in mobile view
    ...
    # Scenario: To verify preferred contact number is mandatory in mobile view 
    # When The candidate clicks on preferred contact field and clicks outside in mobile view
    # Then The candidate seees mandatory validation message in mobile view
