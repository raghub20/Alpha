...
To validate the fields available for candidate needs assessment
  ...
  #    And The candidate answers # of Rooms
  #    And The candidate moves to next and clicks back button
  #   Then The candidate sees the previously selected values in # of Rooms
 ...
 @Mobile
  ...
  #    And The candidate answers # of Rooms in mobile view
  #    And The candidate moves to next and clicks back button in mobile view
  #   Then The candidate sees the previously selected values in # of Rooms in mobile view
